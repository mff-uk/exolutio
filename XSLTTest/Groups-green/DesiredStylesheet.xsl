...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="2.0">
  <!-- Template generated by eXolutio on 4.8.2011 11:47 
    from D:\Programování\EvoXSVN\XSLTTest\Groups-green\groups-green.eXo. -->
  ...
  <xsl:template name="TOP-R-ATT">
    ...
    <xsl:call-template name="TOP-R-wr1r-ATT">
      <xsl:with-param name="ci" select="$ci[name() = 'a3'] | $ci[name() = 'e3'] | $ci[name() = 'a4'] | $ci[name() = 'e4']" />
    </xsl:call-template>
  ...
  <!--PSMAttribute: "c6.a6" 1..1-->
  <xsl:template match="/root/@a5">
    <xsl:attribute name="a6">
      <xsl:value-of select="." />
    </xsl:attribute>
  </xsl:template>
  <!--End of: PSMAttribute: "c6.a6" 1..1-->
  <!-- Instance generators -->
  ...
  <xsl:template name="TOP-R-wr1r-c3-ATT-IG">
    <xsl:param name="count" as="item()" select="1" />
    <xsl:for-each select="1 to $count">
      <xsl:attribute name="a3">a3</xsl:attribute>
    </xsl:for-each>
  </xsl:template>
  ...
  <xsl:template match="c1 | @a1 | e1 | @a2 | e2 | e2m | @a3 | e3 | @a4 | e4 | e6" priority="0">
    <xsl:copy-of select="." />
  </xsl:template>
</xsl:stylesheet>