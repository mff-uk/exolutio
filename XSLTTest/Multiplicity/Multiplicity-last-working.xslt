...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="2.0">
  ...
  <xsl:template name="TOP-Purchase-Items-ELM">
    ...
    <xsl:call-template name="TOP-Purchase-Items-Item-IG">
      <xsl:with-param name="count" select="4 - count(item)" />
    </xsl:call-template>
  </xsl:template>
  <!--PSMClass: "Customer"-->
  ...
  <xsl:template name="TOP-Purchase-CustomerInfo-Customer-ELM">
    ...
    <xsl:call-template name="TOP-Purchase-CustomerInfo-Customer-Address-IG">
      <xsl:with-param name="count" select="1 - count(../address)" />
    </xsl:call-template>
  ...
  <!--PSMClass: "ItemI"-->
  <xsl:template match="/purchase-request/item/item-info">
    <item-info>
