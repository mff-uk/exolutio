...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="2.0">
  <!-- Template generated by eXolutio on 30.7.2011 19:55 
  ...
  <xsl:template name="TOP-Purchase-ATT">
    ...
    <xsl:for-each-group select="$ci[name() = 'subcode'] | $ci[name() = 'code'] | $ci[name() = 'weight'] | $ci[name() = 'title'] | $ci[name() = 'amount'] | $ci[name() = 'unit-price']" group-starting-with="subcode">
