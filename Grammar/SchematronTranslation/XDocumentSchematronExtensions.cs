...
namespace Exolutio.Model.PSM.Grammar.SchematronTranslation
{
    ...
    {
        public static XNamespace SCHEMATRON_NAMESPACE = @"http://www.ascc.net/xml/schematron";
        ...
        public static XElement SchematronPattern(this XElement parentElement, string name)
        {
        ...
        {
            XElement rule = parentElement.SchematronGenericElement("context");
