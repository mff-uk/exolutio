...
namespace Exolutio.Model.OCL {
    public class OclCompilerResult {
        ...
        public OclCompilerResult(Constraints con, PropertyInitializations initializations, ErrorCollection errColl, Library lib, IBridgeToOCL bridge) {
