...
{
    public class EvoXVersionedObjectNotAPartOfSchema : EvoXVersionedObject
    {
        protected Guid projectVersionGuid;

        public EvoXVersionedObjectNotAPartOfSchema(Project p) : base(p) {
        }

        public EvoXVersionedObjectNotAPartOfSchema(Project p, Guid g)
            : base(p, g)
        {
        }
