...
{
    public class guiAdaptationCommand: guiActiveDiagramCommand
    {
        ...
        {
            get { return "Generate adaptation script."; }
        }
        ...
        public override void Execute(object parameter)
        {
            ...
            {
                Adapt(((PSMDiagram)openedVersions.First()).PSMSchema, ((PSMDiagram)Current.ActiveDiagram).PSMSchema);
            }
            else
            {
                ...
                {
                    Adapt((PSMSchema)dialog.selectedObjects.First(), ((PSMDiagram)Current.ActiveDiagram).PSMSchema);
                }
            }
        }
