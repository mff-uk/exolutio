...
namespace EvoX.ViewToolkit
{
    public class WPFHelpers
    {
        ...
        public class FinderMatchType : IFinderMatchVisualHelper
        {
            ...
            public bool DoesMatch(Visual item)
            {
        ...
        public static void FindDownInTree(List<FrameworkElement> lst, Visual parent, Visual ignore, IFinderMatchVisualHelper helper)
        {
