...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron">
  ...
  <sch:pattern id="Tournament">
    <sch:rule context="/tournamentApplication">
      ...
      <sch:assert test="not(exists(requiredQualificationPoints)) or player/points ge requiredQualificationPoints">Participating players must meet the requirements of the tournament</sch:assert>
    </sch:rule>
  </sch:pattern>
