...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron">
  ...
  <sch:pattern id="Tournament">
    <sch:rule context="/tournaments/tournament">
      ...
      <sch:assert test="qualification/@open eq true() or exists(qualification/@leagueName)">Tournament must be either open tournament or belong to a league</sch:assert>
    </sch:rule>
  </sch:pattern>
